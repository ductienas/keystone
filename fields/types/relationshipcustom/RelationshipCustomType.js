...
/**
 * RelationshipCustom FieldType Constructor
 * @extends Field
 * @api public
 */
function relationshipCustom (list, path, options) {
	...
	relationshipCustom.super_.call(this, list, path, options);
}
relationshipCustom.properName = 'RelationshipCustom';
util.inherits(relationshipCustom, FieldType);

/**
 * Get client-side properties to pass to react field.
 */
relationshipCustom.prototype.getProperties = function () {
...
relationshipCustom.prototype.getExpandedData = function (item) {
 ...
 */
relationshipCustom.prototype.addToSchema = function (schema) {
	var field = this;
	var def = {
 ...
 */
relationshipCustom.prototype.getData = function (item) {
	var value = item.get(this.path);
	if (this.many) {
 ...
 */
relationshipCustom.prototype.addFilterToQuery = function (filter) {
	var query = {};
 ...
 */
relationshipCustom.prototype.format = function (item) {
	var value = item.get(this.path);
 ...
 */
relationshipCustom.prototype.validateInput = function (data, callback) {
 ...
 */
relationshipCustom.prototype.validateRequiredInput = function (item, data, callback) {
	var value = this.getValueFromData(data);
	var result = false;
	if (value === undefined) {
		if (this.many) {
 ...
 * Deprecated
 */
relationshipCustom.prototype.inputIsValid = function (data, required, item) {
 ...
 */
relationshipCustom.prototype.updateItem = function (item, data, callback) {
	if (item.populated(this.path)) {
		throw new Error('fieldTypes.relationshipCustom.updateItem() Error - You cannot update populated relationshipCustoms.');
	}
	...
	// Are we handling a many relationshipCustom or just one value?
	if (this.many) {
...
definePrototypeGetters(relationshipCustom, {
	// Returns true if the relationshipCustom configuration is valid
	isValid: function () {
...
/* Export Field Type */
module.exports = relationshipCustom;
